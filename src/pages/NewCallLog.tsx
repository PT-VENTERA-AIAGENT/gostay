        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    <button className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg border-2 border-primary bg-primary/5 text-sm font-medium text-primary btn-press touch-target"><PhoneIncoming className="w-4 h-4" /> Inbound</button>
                    <button className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg border border-border text-sm font-medium text-muted-foreground hover:bg-muted transition-colors btn-press touch-target"><PhoneOutgoing className="w-4 h-4" /> Outbound</button>
                  </div>
                </div>
          ...
          <motion.div variants={staggerContainer} initial="hidden" animate="show" className="space-y-4 md:space-y-6">
            ...
            <motion.div variants={staggerItem}>
              <motion.button whileTap={{ scale: 0.97 }} className="w-full bg-primary text-primary-foreground py-2.5 rounded-lg text-sm font-semibold hover:opacity-90 transition-opacity touch-target">Save Call Log</motion.button>
            </motion.div>
          </motion.div>
        </div>
      </div>
