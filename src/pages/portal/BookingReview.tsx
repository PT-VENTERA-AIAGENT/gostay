        ...
        <motion.div variants={staggerContainer} initial="hidden" animate="show" className="space-y-4">
          <motion.div variants={staggerItem} className="bg-card rounded-xl border border-border p-4 md:p-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
              ...
              <div><span className="text-muted-foreground">{t("Max Occupancy")}</span><p className="font-medium text-foreground mt-0.5">{guestsLabel(roomType.max_occupancy, t)}</p></div>
          ...
          <motion.div variants={staggerItem} className="bg-card rounded-xl border border-border p-4 md:p-5">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
                <span className="text-muted-foreground">{nightsLabel(nights, t)} × {formatIDR(roomType.base_rate)}</span>
