    ...
    <PageTransition>
      <div className="max-w-3xl mx-auto px-4 md:px-8 py-6 md:py-8 space-y-6">
        ...
        <div className="flex items-center justify-between">
          <Link to="/portal/book/details" className="flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground transition-colors"><ArrowLeft className="w-4 h-4" /> Back</Link>
          <Link to="/portal/book/confirmation" className="bg-primary text-primary-foreground px-5 md:px-6 py-2.5 rounded-lg text-sm font-semibold hover:opacity-90 transition-opacity flex items-center gap-2">Confirm Booking <Check className="w-4 h-4" /></Link>
        </div>
      </div>
    </PageTransition>
  );
