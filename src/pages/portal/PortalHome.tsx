...
export default function PortalHome() {
  return (
    <div>
      {/* Hero */}
      <section className="relative bg-primary/5 px-8 py-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-5xl font-bold text-foreground mb-4 leading-tight">Find Your Perfect<br />Stay at BookMe Hotel</h1>
          <p className="text-lg text-muted-foreground mb-10 max-w-2xl mx-auto">Discover comfort and luxury in the heart of the city. Book directly for the best rates and exclusive perks.</p>
          ...
          {featuredRooms.map((room) => (
            ...
            >
              <div className="aspect-[16/9] bg-muted flex items-center justify-center text-muted-foreground text-sm relative">
                Room Photo
                <span className="absolute top-3 right-3 bg-card/90 backdrop-blur text-xs font-medium px-2.5 py-1 rounded-full text-foreground border border-border">{room.bedType}</span>
              </div>
              <div className="p-5">
      ...
      <section className="px-8 py-12 bg-muted/30">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-8">
            <h2 className="text-2xl font-bold text-foreground">What Our Guests Say</h2>
            <p className="text-sm text-muted-foreground mt-1">Real reviews from real guests</p>
          </div>
      ...
      {/* Hotel Info */}
      <section className="px-8 py-16 bg-card border-t border-border">
        <div className="max-w-4xl mx-auto text-center">
