...
export default function BookingConfirmation() {
  return (
    <div className="max-w-lg mx-auto px-8 py-16 text-center space-y-6">
      ...
      <div className="flex items-center gap-3 justify-center">
        <Link to="/portal/my-account" className="flex items-center gap-2 px-5 py-2.5 rounded-lg border border-border text-sm font-medium text-foreground hover:bg-muted transition-colors">
          <Calendar className="w-4 h-4" /> My Bookings
        </Link>
        <Link to="/portal" className="flex items-center gap-2 px-5 py-2.5 rounded-lg bg-primary text-primary-foreground text-sm font-semibold hover:opacity-90 transition-opacity">
