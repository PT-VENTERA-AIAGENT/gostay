...
import { ArrowLeft, Search, User, Calendar, MapPin, Users } from "lucide-react";
      ...
      <div className="grid grid-cols-3 gap-6">
        <div className="col-span-2 space-y-6">
          ...
          <div className="bg-card rounded-xl border border-border p-5">
            ...
            <div className="flex items-center gap-3 mb-4">
              <div className="flex items-center gap-2 bg-background border border-input rounded-lg px-4 py-2.5 flex-1">
                <Search className="w-4 h-4 text-muted-foreground" />
                <input placeholder="Search existing guest by name, email, or phone..." className="bg-transparent text-sm text-foreground placeholder:text-muted-foreground outline-none w-full" />
              </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input type="text" className="w-full px-4 py-2.5 rounded-lg border border-input bg-background text-sm placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring" placeholder="Guest name" />
              </div>
              <div>
                <label className="text-sm font-medium text-foreground mb-1.5 block">Email</label>
                <input type="email" className="w-full px-4 py-2.5 rounded-lg border border-input bg-background text-sm placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring" placeholder="guest@email.com" />
              </div>
              <div>
                <label className="text-sm font-medium text-foreground mb-1.5 block">Phone</label>
                <input type="tel" className="w-full px-4 py-2.5 rounded-lg border border-input bg-background text-sm placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring" placeholder="+62..." />
              </div>
              <div>
                <label className="text-sm font-medium text-foreground mb-1.5 block">Nationality</label>
                <input type="text" className="w-full px-4 py-2.5 rounded-lg border border-input bg-background text-sm placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring" placeholder="Indonesia" />
              </div>
            </div>
          </div>
          ...
          <div className="bg-card rounded-xl border border-border p-5">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input type="date" className="w-full px-4 py-2.5 rounded-lg border border-input bg-background text-sm focus:outline-none focus:ring-2 focus:ring-ring" />
              </div>
              <div>
              ...
              <div>
                ...
                <input type="number" defaultValue={1} min={1} className="w-full px-4 py-2.5 rounded-lg border border-input bg-background text-sm focus:outline-none focus:ring-2 focus:ring-ring" />
              </div>
              <div>
                <label className="text-sm font-medium text-foreground mb-1.5 block">Children</label>
                <input type="number" defaultValue={0} min={0} className="w-full px-4 py-2.5 rounded-lg border border-input bg-background text-sm focus:outline-none focus:ring-2 focus:ring-ring" />
              </div>
            </div>
          </div>
          ...
          <div className="bg-card rounded-xl border border-border p-5">
            ...
            <div>
              ...
              <textarea rows={3} className="w-full px-4 py-2.5 rounded-lg border border-input bg-background text-sm placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring resize-none" placeholder="Any special requests from the guest..." />
            </div>
          </div>
        ...
        <div>
          <div className="bg-card rounded-xl border border-border p-5 sticky top-6">
            ...
            <button className="w-full bg-primary text-primary-foreground py-2.5 rounded-lg text-sm font-semibold hover:opacity-90 transition-opacity mt-6">
              Create Booking
            </button>
          </div>
        </div>
