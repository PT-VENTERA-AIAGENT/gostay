        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6">
          ...
          <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2, duration: 0.35 }}>
            <div className="bg-card rounded-xl border border-border p-4 md:p-5 sticky top-6">
              ...
              <motion.button whileTap={{ scale: 0.98 }} className="w-full bg-primary text-primary-foreground py-2.5 rounded-lg text-sm font-semibold hover:opacity-90 transition-opacity mt-6 touch-target btn-press">Create Booking</motion.button>
            </div>
          </motion.div>
        </div>
      </div>
